...
const GetDonation = () => {
    ...
    return (
        ...
        <div className="donation-introduction">
            ...
            <p>Our program operates on the principle that menstrual health is a right, not a privilege. Therefore, everyone in need of menstrual hygiene products is welcome to apply for support. We aim to ensure that no one is left without access to essential menstrual care.</p>
        </div>
        {/* <SummaryBoard /> */}
